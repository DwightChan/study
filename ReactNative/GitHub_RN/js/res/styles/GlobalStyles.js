...
export let isIPhoneX = DeviceInfo.isIPhoneX_deprecated;

const STATUS_BAR_HEIGHT_IOS = isIPhoneX ? STATUS_BAR_HEIGHT_IPHONEX : STATUS_BAR_HEIGHT_IPHONE;
const STATUS_BAR_HEIGHT_ANDROID = 0; // Android 的status 被系统保留


export let isIOS = Platform.OS === "ios" ? true : false;
// 状态栏的高度
...
export let WINDOW = Dimensions.get('window');
