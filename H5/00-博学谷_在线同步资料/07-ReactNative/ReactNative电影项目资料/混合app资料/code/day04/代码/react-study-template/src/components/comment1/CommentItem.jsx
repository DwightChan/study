...
// 在 webpack.config.js 文件中 module --> rules 属性通过 为 css-loader 添加 modules 参数，启用 CSS 的模块化
...
export default function CommentItem(props) {
  ...
  // 注意： 在 style 的样式规则中，如果 属性值的单位是 px, 则 px 可以省略，直接写一个 数值 即可, 如果要写px 在后面则是字符串形式
  ...
  // 样式优化 4
  // 在顶部导入 css , import '../../css/commentItem.css'
